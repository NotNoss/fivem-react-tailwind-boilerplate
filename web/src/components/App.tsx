...
const App: React.FC = () => {
  ...
  return (
    <div className="text-center h-full flex justify-center items-center">
      <div className='bg-background rounded-[10px] w-[500px] h-[400px] flex justify-center items-center text-white'>
        <div>
          <h1>This is the NUI Popup!</h1>
          <p>Exit with the escape key</p>
          <button className='bg-button px-4 py-2 rounded-xl'  onClick={handleGetClientData}>Get Client Data</button>
