...
<div align="center">
A simple and extendable React (TypeScript) and Tailwind boilerplate designed around the Lua ScRT based on the boilerplate by Project Error
</div>
...
with React and Tailwind in NUI. It contains several helpful utilities and
